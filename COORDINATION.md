...
# Aggiornato: 4 lug 2026 — sessione Cowork (coordinatore)
...
| #3 Governance experiments | DA FARE | Sessione NUOVA | Memo Consiglio Direttivo                |
...
- **docs/** → SOLO sessione Nuova (governance memo)
- **Nessun deploy** su main/Cloud Run senza conferma utente esplicita

## Prossimi step

Sessione Fontanin → fase 5: WalletCard.jsx ASA ID + Algorand indexer
Sessione Nuova → finding #3: docs/GOVERNANCE_MEMO_experiments.md
